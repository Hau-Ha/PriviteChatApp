...
import IniviteSuggestionList from "../newGroupChat/IniviteSuggestionList.tsx";
import SelectedUsersList from "../newGroupChat/SelectedUsersList.tsx";
...
const NewGroupChatModal = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    try {
      ...
      console.error(
        "Error occurred in handleSubmit in NewGroupChatModal:",
        error
      );
    }
  };
